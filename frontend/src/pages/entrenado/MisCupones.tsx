  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Tus descuentos y beneficios exclusivos</p>
      </div>
              ...
              >
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-4">
                    ...
                    <div className="mt-3">
                      <span className="inline-flex items-center px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-bold">
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-center text-white">
              {selectedCupon.cupon.negocio?.logo ? (
                <div className="w-20 h-20 mx-auto bg-white rounded-xl p-2 mb-4">
                  <img
                ...
                <div className="w-20 h-20 mx-auto bg-white/20 rounded-xl flex items-center justify-center mb-4">
            ...
            {/* Descuento destacado */}
            <div className="bg-yellow-50 border-y-4 border-dashed border-yellow-200 py-6 text-center">
              <span className="text-3xl font-bold text-yellow-700">
                {formatDescuento(selectedCupon.cupon)}
              </span>
              {selectedCupon.cupon.codigo && (
                <div className="mt-3">
                  <p className="text-sm text-gray-500 mb-1">Presentá este código:</p>
                  <span className="font-mono text-xl bg-white px-4 py-2 rounded-lg border-2 border-dashed border-gray-300">
                    {selectedCupon.cupon.codigo}
                  </span>
                </div>
              )}
            ...
            <div className="p-6 space-y-4">
              {selectedCupon.cupon.descripcion && (
                <p className="text-gray-600">{selectedCupon.cupon.descripcion}</p>
              )}
