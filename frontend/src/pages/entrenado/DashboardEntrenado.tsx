      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Sesión de hoy</h2>
          ...
          {sesionHoy ? (
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-medium text-gray-900">Sesión {sesionHoy.numero}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Mi progreso</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-medium text-gray-900">{estadisticas.porcentaje_asistencia}%</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="text-center p-3 bg-orange-50 rounded-lg overflow-hidden">
                  ...
                  <p className="text-xs text-gray-500 mt-1 truncate">Racha actual</p>
                </div>
                <div className="text-center p-3 bg-blue-50 rounded-lg overflow-hidden">
                  ...
                  <p className="text-xs text-gray-500 mt-1 truncate">Este mes</p>
                </div>
              </div>
            </div>
          ) : (
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Mi plan</span>
          </Link>
