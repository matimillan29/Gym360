    ...
    <div className="space-y-6 fade-in">
      ...
      {estadisticas && (
        <div className="grid grid-cols-4 gap-2 md:gap-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-3 text-center overflow-hidden">
            <div className="w-8 h-8 mx-auto rounded-lg bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center mb-1">
              <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
              </svg>
            </div>
            <p className="text-xl font-bold text-gray-900 dark:text-white">{estadisticas.total_sesiones}</p>
            <p className="text-[10px] text-gray-500 dark:text-gray-400 truncate">Sesiones</p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-3 text-center overflow-hidden">
            <div className="w-8 h-8 mx-auto rounded-lg bg-green-100 dark:bg-green-900/50 flex items-center justify-center mb-1">
              <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <p className="text-xl font-bold text-gray-900 dark:text-white">{estadisticas.sesiones_completadas}</p>
            <p className="text-[10px] text-gray-500 dark:text-gray-400 truncate">Completadas</p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-3 text-center overflow-hidden">
            <div className="w-8 h-8 mx-auto rounded-lg bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center mb-1">
              <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
              </svg>
            </div>
            <p className="text-xl font-bold text-gray-900 dark:text-white">{estadisticas.asistencia_porcentaje}%</p>
            <p className="text-[10px] text-gray-500 dark:text-gray-400 truncate">Asistencia</p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-3 text-center overflow-hidden">
            <div className="w-8 h-8 mx-auto rounded-lg bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center mb-1">
              <svg className="w-4 h-4 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
              </svg>
            </div>
            <p className="text-xl font-bold text-gray-900 dark:text-white truncate">{estadisticas.tonelaje_total.toLocaleString()}</p>
            <p className="text-[10px] text-gray-500 dark:text-gray-400 truncate">Tonelaje (kg)</p>
          </div>
        </div>
      )}
